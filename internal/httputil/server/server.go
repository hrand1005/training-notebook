...
// New creates a Server with the provided config.
func New(conf config.ServerConfig) (Server, error) {
	app := fiber.New(
		fiber.Config{
...
// Handler defines an interface for registering handlers to a router.
